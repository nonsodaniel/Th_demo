...
const GiveFeedbackForm: React.FC<{ user: UserT; onFeedbackGiven: () => void; onGoBack: () => void }> =
            ...
            <div className="qstn-rating">
              ...
              <div className="rating">
                <span className="tooltip">
                  ...
                  <span className="tooltiptext">I have feedback about this question, please ask me about it. </span>
                </span>
